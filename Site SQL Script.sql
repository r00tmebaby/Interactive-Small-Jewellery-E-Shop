...
CREATE TABLE `category` (
  ...
  `category_name` varchar(255) COLLATE cp1251_bulgarian_ci DEFAULT NULL,
  `items` int(11) DEFAULT '0',
  `sub_categories` text COLLATE cp1251_bulgarian_ci,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=cp1251 COLLATE=cp1251_bulgarian_ci;

-- ----------------------------
-- Records of category
-- ----------------------------
INSERT INTO `category` VALUES ('4', 'Pendants', '0', null);
INSERT INTO `category` VALUES ('6', 'Earrings', '0', null);
INSERT INTO `category` VALUES ('8', 'Rings', '0', null);
INSERT INTO `category` VALUES ('10', 'Bracelets', '0', null);
INSERT INTO `category` VALUES ('12', 'Necklaces', '0', null);
INSERT INTO `category` VALUES ('14', 'Chains', '0', null);
INSERT INTO `category` VALUES ('16', 'Promotions', '0', null);
INSERT INTO `category` VALUES ('18', 'New Arrivals', '0', null);
...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=120 DEFAULT CHARSET=cp1251 COLLATE=cp1251_bulgarian_ci;
...
INSERT INTO `products` VALUES ('118', 'Bracelets', 'Sterling Silver White Lab Opala', '1001P8', '14.35', '', '100', '../images/products/Bracelets/er2323.jpg');
INSERT INTO `products` VALUES ('119', 'Rings', 'koko', '12223', '12', '<!DOCTYPE html>\r\n<html>\r\n<head>\r\n</head>\r\n<body>\r\n<ul>\r\n<li><strong>Height:</strong>&nbsp;13.8mm</li>\r\n<li><strong>Width:</strong>14.1mm</li>\r\n<li><strong>Thickness:</strong>&nbsp;0.8mm</li>\r\n</ul>\r\n<ul>\r\n<li><strong>Stone material:</strong>&nbsp;blue lab created opal</li>\r\n<li><strong>Center Stone Size:</strong>&nbsp;7</li>\r\n<li><strong>Stone shape:</strong>&nbsp;round</li>\r\n<li><strong>Center Stone Carat weight:</strong>&nbsp;1.28ct</li>\r\n<li><strong>Total number of CZ stones:</strong>&nbsp;2</li>\r\n<li><strong>Stone setting:</strong>&nbsp;prong setting</li>\r\n</ul>\r\n<ul>\r\n<li><strong>Metal:</strong>&nbsp;925 sterling silver</li>\r\n<li><strong>Plating:</strong>&nbsp;Rodium Plated</li>\r\n<li><strong>Finish:</strong>high polish</li>\r\n</ul>\r\n</body>\r\n</html>', '100', '../images/products/Rings/er2323.jpg');
...
CREATE TABLE `users` (
  ...
  `modules` text COLLATE cp1251_bulgarian_ci,
  `email` text COLLATE cp1251_bulgarian_ci,
  `address` text COLLATE cp1251_bulgarian_ci,
  `phone` text COLLATE cp1251_bulgarian_ci,
  `rights` int(11) DEFAULT '0',
  `reg_date` int(11) DEFAULT NULL,
  `reg_ip` varchar(255) COLLATE cp1251_bulgarian_ci DEFAULT NULL,
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('2', 'test', 'test', '{\"home\":\"Home\",\"additem\":\"New Product\",\"users\":\"User Settings\",\"search\":\"Search Item\",\"history\":\"Sell History\"}', null, null, null, '1', null, null, null);
