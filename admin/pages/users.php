...
$link = "";
 if(isset($_GET['itemid'])){
	 $link = '<span style="margin-left:2%;position:absolute;"><a href="?page=user"><span class="glyphicon glyphicon-hand-left  " aria-hidden="true"></span>  </a></span>';
 }
?>
...
<div class="row">
    <div class="col-lg-12">
       <h1 class="page-header">User Settings <?php echo $link;?></h1>
    </div>
    <!-- /.col-lg-12 -->
	                            ...
	                            <form class="form-inline" id="products" method="post">
									<div class="form-group select-group">
                                        ...
                                        <select class="form-control mr-sm-2" name="itm_type">									
	                            		   ...
	                            		   <option value="3" >By IP Address</option>
	                            		</select>
	                            	</div>
        	                ...
        	                <div class="col-sm-6">
                                <form class="form"  method="post">       	
			                		...
			                		<div class="form-group">
			                		    ...
			                		    <textarea class="form-control text-area" name="product_description"> <?php echo $rowsa['description']; ?></textarea>
        	                	    </div>
        	                        <div class="form-group">
